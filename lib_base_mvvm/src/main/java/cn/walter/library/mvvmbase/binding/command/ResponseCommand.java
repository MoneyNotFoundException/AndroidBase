package cn.walter.library.mvvmbase.binding.command;
...
public class ResponseCommand<T, R> {
    ...
    public ResponseCommand(Func1<T, R> execute, BindingFunction<Boolean> canExecute) {
        this.function = execute;
        this.canExecute = canExecute;
    }
