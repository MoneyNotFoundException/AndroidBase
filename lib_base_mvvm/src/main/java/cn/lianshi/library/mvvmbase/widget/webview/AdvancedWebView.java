package cn.lianshi.library.mvvmbase.widget.webview;
...
import cn.lianshi.library.mvvmbase.utils.ui.DensityUtils;
...
public class AdvancedWebView extends WebView {
    ...
    public interface JsAlertLister {
    ...
    protected JsAlertLister mJsAlertLister;
    ...
    private String jumpcode = "";//网页跳转code
    ...
    public void setJsAlertListener(Activity activity, JsAlertLister jsAlertListener) {
        if (activity != null) {
            mActivity = new WeakReference<>(activity);
        } else {
            mActivity = null;
        }
        mJsAlertLister = jsAlertListener;
    ...
    protected void init(final Context context) {
        ...
        super.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(final WebView view, final String url) {
                ...
                System.out.println("shouldOverrideUrlLoadingUrl=" + url);

                //挂号需要拦截，跳转其他webview的回调
                if (jumpcode.equals("444")) {
...
//				super.onProgressChanged(view, newProgress);
            ...
            public boolean onJsAlert(WebView view, String url, String message, JsResult result) {
                result.confirm();
                if (mJsAlertLister != null) {
                    mJsAlertLister.onJsAlert(view, url, message, result);
                }
                if (mCustomWebChromeClient != null) {
...
//                        DialogUtils.showListViewDialog(mActivity.get(), listView, "请选择", (view, integer) -> {
...
//                                    .subscribe(new Action1<Boolean>() {
//                                        @Override
//                                        public void call(Boolean granted1) {
//                                            if (granted1) {
//                                                if (cameraIntent == null) {
//                                                    cameraIntent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
//                                                    /**
//                                                     *   在android N(sdk 24以上) 以上的设备上,以前的老方法不顶用了,会导致crash,
//                                                     *   只能用过ContentProvider来传递uri
//                                                     */
//                                                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
//                                                        Uri uri = FileProvider.getUriForFile(mActivity.get(),
//                                                            RxApplication.getInstance().getmContext().getPackageName() + ".provider", mPhotoFile);
