package cn.lianshi.library.mvvmbase.widget.scrollbiew;
/*
...
public class OverScrollView extends FrameLayout implements OnTouchListener
{
	...
	/**
	 * <p>
	 * Finds the next focusable component that fits in this View's mBounds
	 * (excluding fading edges) pretending that this View's top is located at
	 * the parameter top.
	 * </p>
	 * 
	 * @param topFocus
	 *            look for a candidate is the one at the top of the mBounds if
	 *            topFocus is true, or at the bottom of the mBounds if topFocus
	 *            is false
	 * @param top
	 *            the top offset of the mBounds in which a focusable must be
	 *            found (the fading edge is assumed to start at this position)
	 * @param preferredFocusable
	 *            the View that has highest priority and will be returned if it
	 *            is within my mBounds (null is valid)
	 * @return the next focusable component in the mBounds or null if none can be
	 *         found
	 */
	...
	/**
	 * <p>
	 * Finds the next focusable component that fits in the specified mBounds.
	 * </p>
	 * 
	 * @param topFocus
	 *            look for a candidate is the one at the top of the mBounds if
	 ...
	 *            found
	 * @param bottom
	 *            the bottom offset of the mBounds in which a focusable must be
	 *            found
	 * @return the next focusable component in the mBounds or null if none can be
	 *         found
	 */
	private View findFocusableViewInBounds(boolean topFocus, int top, int bottom)
	{
		 ...
		 * mBounds, but it also has some part that is not within mBounds. A fully
	 ...
	 * 
	 * <p>
	 * This version also clamps the scrolling to the mBounds of our child.
	 */
	@Override
