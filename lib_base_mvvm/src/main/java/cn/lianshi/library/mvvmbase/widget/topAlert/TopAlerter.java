package cn.lianshi.library.mvvmbase.widget.topAlert;
...
public final class TopAlerter {
     ...
     * @return This TopAlerter
     */
    public static TopAlerter create(@NonNull final Activity activity) {
        if (activity == null) {
            throw new IllegalArgumentException("Activity cannot be null!");
        }

        final TopAlerter alerter = new TopAlerter();

        //Hide current Alert, if one is active
        TopAlerter.clearCurrent(activity);

        alerter.setActivity(activity);
        alerter.setAlert(new TopAlertDialog(activity));
    ...
    public static void clearCurrent(@NonNull final Activity activity) {
        ...
        try {
            ...
            Log.e(TopAlerter.class.getClass().getSimpleName(), Log.getStackTraceString(ex));
        }
    }
     ...
     * @return This TopAlerter
     */
    public TopAlerter setTitle(@StringRes final int titleId) {
        if (getAlert() != null) {
     ...
     * @return This TopAlerter
     */
    public TopAlerter setTitle(final String title) {
        if (getAlert() != null) {
     ...
     * @return This TopAlerter
     */
    public TopAlerter setTitleTypeface(@NonNull final Typeface typeface) {
        if (getAlert() != null) {
     ...
     * @return This TopAlerter
     */
    public TopAlerter setTitleAppearance(@StyleRes final int textAppearance) {
        if (getAlert() != null) {
     ...
     * @return This TopAlerter
     */
    public TopAlerter setContentGravity(final int gravity) {
        if (getAlert() != null) {
     ...
     * @return This TopAlerter
     */
    public TopAlerter setText(@StringRes final int textId) {
        if (getAlert() != null) {
     ...
     * @return This TopAlerter
     */
    public TopAlerter setText(final String text) {
        if (getAlert() != null) {
     ...
     * @return This TopAlerter
     */
    public TopAlerter setTextTypeface(@NonNull final Typeface typeface) {
        if (getAlert() != null) {
     ...
     * @return This TopAlerter
     */
    public TopAlerter setTextAppearance(@StyleRes final int textAppearance) {
        if (getAlert() != null) {
     ...
     * @return This TopAlerter
     */
    public TopAlerter setBackgroundColorInt(@ColorInt final int colorInt) {
        if (getAlert() != null) {
     ...
     * @return This TopAlerter
     */
    public TopAlerter setBackgroundColorRes(@ColorRes final int colorResId) {
     ...
     * @return This TopAlerter
     */
    public TopAlerter setBackgroundDrawable(final Drawable drawable) {
        if (getAlert() != null) {
     ...
     * @return This TopAlerter
     */
    public TopAlerter setBackgroundResource(@DrawableRes final int drawableResId) {
        if (getAlert() != null) {
     ...
     * @return This TopAlerter
     */
    public TopAlerter setIcon(@DrawableRes final int iconId) {
        if (getAlert() != null) {
     ...
     * @return This TopAlerter
     */
    public TopAlerter setIcon(@NonNull final Bitmap bitmap) {
        if (getAlert() != null) {
     ...
     * @return This TopAlerter
     */
    public TopAlerter setIcon(@NonNull final Drawable drawable) {
        if (getAlert() != null) {
     ...
     * @return This TopAlerter
     */
    public TopAlerter setOnClickListener(@NonNull final View.OnClickListener onClickListener) {
        if (getAlert() != null) {
     ...
     * @return This TopAlerter
     */
    public TopAlerter setDuration(@NonNull final long milliseconds) {
        if (getAlert() != null) {
     ...
     * @return This TopAlerter
     */
    public TopAlerter enableIconPulse(final boolean pulse) {
        if (getAlert() != null) {
     ...
     * @return This TopAlerter
     */
    public TopAlerter showIcon(final boolean showIcon) {
        if (getAlert() != null) {
     ...
     * @return This TopAlerter
     */
    public TopAlerter enableInfiniteDuration(final boolean infiniteDuration) {
        if (getAlert() != null) {
     ...
     * @return This TopAlerter
     */
    public TopAlerter setOnShowListener(@NonNull final OnShowAlertListener listener) {
        if (getAlert() != null) {
     ...
     * @return This TopAlerter
     */
    public TopAlerter setOnHideListener(@NonNull final OnHideAlertListener listener) {
        if (getAlert() != null) {
     ...
     * @return This TopAlerter
     */
    public TopAlerter enableVibration(final boolean enable) {
        if (getAlert() != null) {
     ...
     * @return This TopAlerter
     */
    public TopAlerter enableProgress(final boolean enable) {
        if (getAlert() != null) {
    ...
    /**
     * Gets the Alert associated with the TopAlerter
     *
     ...
     *
     * @return The Decor View of the Activity the TopAlerter was called from
     */
    @Nullable
