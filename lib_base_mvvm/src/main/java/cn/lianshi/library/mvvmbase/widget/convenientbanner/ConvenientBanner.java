package cn.lianshi.library.mvvmbase.widget.convenientbanner;
...
import cn.lianshi.library.mvvmbase.widget.convenientbanner.adapter.CBPageAdapter;
import cn.lianshi.library.mvvmbase.widget.convenientbanner.holder.CBViewHolderCreator;
import cn.lianshi.library.mvvmbase.widget.convenientbanner.listener.CBPageChangeListener;
import cn.lianshi.library.mvvmbase.widget.convenientbanner.listener.OnItemClickListener;
import cn.lianshi.library.mvvmbase.widget.convenientbanner.view.CBLoopViewPager;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    private void init(Context context) {
        View hView = LayoutInflater.from(context).inflate(
                R.layout.base_cb_loop_viewpager, this, true);
