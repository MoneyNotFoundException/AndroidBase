 ...
 * @since 26/01/2016
 **/
public class TopAlertDialog extends FrameLayout implements View.OnClickListener, Animation.AnimationListener, SwipeDismissTouchListener.DismissCallbacks {
     ...
     */
    public TopAlertDialog(@NonNull final Context context) {
     ...
     */
    public TopAlertDialog(@NonNull final Context context, @Nullable final AttributeSet attrs) {
     ...
     */
    public TopAlertDialog(@NonNull final Context context, @Nullable final AttributeSet attrs, final int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView();
    }

    private void initView() {
        inflate(getContext(), R.layout.base_alerter_alert_view, this);
        ...
        slideInAnimation = AnimationUtils.loadAnimation(getContext(), R.anim.base_alerter_slide_in_from_top);
        slideOutAnimation = AnimationUtils.loadAnimation(getContext(), R.anim.base_alerter_slide_out_to_top);
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        if (!marginSet) {
            ...
            params.topMargin = getContext().getResources().getDimensionPixelSize(R.dimen.base_alerter_alert_negative_margin_top);
            requestLayout();
        }
    }
    ...
    public void onAnimationEnd(final Animation animation) {
        ...
        if (enableIconPulse && ivIcon.getVisibility() == VISIBLE) {
            try {
                ivIcon.startAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.base_alerter_pulse));
            } catch (Exception ex) {
            ...
            public void run() {
                try {
                    if (getParent() == null) {
                        ...
                        try {
                            ((ViewGroup) getParent()).removeView(TopAlertDialog.this);
